...
public class PushService extends Service
{
	...
	private static  String		MQTT_HOST = "52.74.136.61";//broker的ip
	// the port at which the broker is running. 
	private static int				MQTT_BROKER_PORT_NUM      = 80;//broker的端口
	...
	private static short			MQTT_KEEP_ALIVE           = 60 * 15;//推送服务持续的时间，这里设置成15分钟
	...
	public static String			MQTT_CLIENT_ID = "gpio";//topic
	...
	// Notification title
	public static String			NOTIF_TITLE = "考研咨询";//提醒的标题
	// Notification id
	...
	public void onCreate() {
        ...
        Notification notification = new Notification(R.drawable.icon,"考研助手",
                System.currentTimeMillis());
        Intent notificationIntent = new Intent(this,getApplication().getClass());
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);
        notification.setLatestEventInfo(this, "考研助手",
                "考研助手运行中", pendingIntent);
